...
public class Producto extends Base {
    ...
    // Constructor completo (incluye la categoría asociada)
    ...
    // toString() limpio para que cuando listemos productos en consola se vea ordenado
    @Override
    public String toString() {
        ...
        return "Producto [ID=" + getId() + ", Nombre=" + nombre + ", Precio=$" + precio +
                ", Stock=" + stock + ", Cat=" + nombreCat + ", Disponible=" + disponible + "]";
    }
}